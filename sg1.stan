...
data {
   ...
   // Covariates
    ...
    int <lower=0, upper=1> intercept[J]; // PostcodeAreaE as "base""
...
transformed parameters  {
   ...
   for (i in 1:J) {
     // Linear predictor
     lp[i] = beta[1] + beta[2]*PostcodeAreaEC[i] + beta[3]*PostcodeAreaN[i] + beta[4]*PostcodeAreaNW[i] + beta[5]*PostcodeAreaSE[i] + beta[6]*PostcodeAreaSW[i]+ beta[7]*PostcodeAreaW[i] + beta[8]*PostcodeAreaWC[i]; // NYI // + offset[i];
